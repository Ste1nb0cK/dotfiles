...
#alias for activating Spack shell support
alias spack_activate='. /home/ste1nb0ck/spack/share/spack/setup-env.sh'
#alias for dotfile managment
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/ste1nb0ck/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ste1nb0ck/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ste1nb0ck/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
